                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <a class="brand-logo" href="{{route('login')}}">
                            ...
                            <h2 class="brand-text text-primary ms-1">
                                <img src="/images/sociales.png" width="40px" height="40px">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Bienvenido a Encuestas! 👋</h2>
                                ...
                                <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="email" type="text" name="email"
                                            placeholder="john@sisme.com" aria-describedby="email" autofocus=""
                                            tabindex="1" />
                                    </div>
                                    <div class="mb-1">
                                ...
                                {{-- <div class="auth-footer-btn d-flex justify-content-center">
                                    <a class="btn btn-facebook" href="#"><i data-feather="facebook"></i></a><a
                                        ...
                                        href="#"><i data-feather="github"></i></a>
                                </div> --}}
                            </div>
                        </div>
                        <!-- /Login-->
