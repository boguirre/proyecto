        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    <h1 class="mb-1">Editar Sub Dimensión</h1>
                    <p></p>
                </div>


                <form id="editActividad" class="row gy-1 pt-75 formactualizar"
                    action="{{ route('subdimensiones.update', 2) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="col-md-12">
                        <div class="row">
                            ...
                            <div class="col-md-12 mt-1">
                                ...
                                <select name="edit_dimension_id" id="edit_dimension_id" class="form-select" required
                                    style="width: 100%">
