...
<ul class="nav navbar-nav align-items-center ms-auto">
        ...
        <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
            ...
            <li class="scrollable-container media-list">
                <div class="list-item align-items-center"><img class="d-block rounded me-1"
                    ...
                    <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                        <div class="media-heading">
                            <h6 class="cart-item-title"><a class="text-body" href="app-ecommerce-details.html"> Apple
                ...
                <div class="list-item align-items-center"><img class="d-block rounded me-1"
                    ...
                    <div class="list-item-body flex-grow-1"><i class="ficon cart-item-remove" data-feather="x"></i>
                        <div class="media-heading">
                            <h6 class="cart-item-title"><a class="text-body" href="app-ecommerce-details.html"> iMac
    ...
    <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
            ...
            <div class="user-nav d-sm-flex d-none"><span
                    class="user-name fw-bolder">{{ auth()->user()->name }}</span><span class="user-status">Admin</span>
            </div><span class="avatar"><img class="round" src="{{ Auth::user()->profile_photo_url }}" alt="avatar"
        ...
        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
            ...
            <a>
                <form method="POST" action="{{ route('logout') }}" class="me-50">
                    @csrf
            ...
            {{-- <a class="dropdown-item" href="{{ route('logout') }}" action="{{ route('logout') }}">
                    <i class="me-50" data-feather="power">
                    </i> Cerrar Sesión
                    @csrf
