    ...
    <ul class="nav navbar-nav flex-row">
        <li class="nav-item me-auto"><a class="navbar-brand" href="">
                <span class="brand-logo">
                    ...
                    <img src="/images/sociales.png">

                </span>
                <h2 class="brand-text">ENCUESTAS</h2>
            </a></li>
...
<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li class=" navigation-header"><span data-i18n="Apps &amp; Pages">Consulta Gerencial</span><i
                data-feather="more-horizontal"></i>
        </li>

        <li class="nav-item {{ Request::is('ficha-consulta') | Request::is('ficha-consulta/*') ? 'active' : '' }}"><a
                class="d-flex align-items-center" href="{{ route('ficha-consulta.index') }}">

                <i data-feather="users"></i>

                <span class="menu-title text-truncate" data-i18n="Chat">Ficha de Consulta</span>
