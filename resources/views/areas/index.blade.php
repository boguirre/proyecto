                        ...
                        <form id="search-form" class="mb-3">
                            <div class="input-group">
                                <input type="text" name="search" id="search-input" class="form-control"
                                    placeholder="Buscar por nombre de tipo de actividad">
                            ...
                            <tbody id="result-table">
                                ...
                                @foreach ($areas as $area)
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                class="btn {{ $area->estado == '1' ? 'btn-success' : 'btn-danger' }}">
                                        ...
                                        {{-- @can('areas.destroy') --}}
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <form action="{{ route('areas.activar', $area) }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body pb-5 px-sm-5 pt-50">
                        ...
                        <form id="editAddForm" class="row gy-1 pt-75 formguardar"
                            action="{{ route('areas.store') }}" method="POST">
